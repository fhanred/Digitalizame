        ...
        <div className="container mx-auto py-2">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div id="next-section" className="flex flex-col md:flex-row mt-8">
              <div className="w-full md:w-1/4 ml-0 md:ml-40">
        ...
        <div id="third-section" className="flex flex-col md:flex-row mt-8">
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <p className="text-xl md:text-2xl font-medium text-gray-300">
              Aquí va el texto que quieres mostrar <br />
              a la izquierda del tercer video. <br />
              Puedes agregar más contenido según sea necesario.
            </p>
          </div>
          <div className="w-full md:w-1/6 ml-0 md:ml-40">
            <video controls className="w-full rounded-3xl shadow-lg">
